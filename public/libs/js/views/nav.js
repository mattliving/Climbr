...
(function() {
  ...
  define(["jquery", "underscore", "backbone", "views/baseview", "text!templates/mainNav.html", "text!templates/subNav.html", "bootstrap", "jqueryui/slider"], function($, _, Backbone, BaseView, mainNav, subNav) {
    var NavView;
